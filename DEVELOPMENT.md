...
| Date    | Notes                                                        |
| ------- | ------------------------------------------------------------ |
| 4/16/19 | Created a high-level pseudocode outline of functions on the side on OneNote (a screenshot was added to git). Added all needed functions, structs, and classes to the header files in the project. Reorganized the filesystem. |
